...
**Suggested Reading Order: kNNTutorial1.Rmd walks you through our implementation of the function and applies it to a boring but easy-to-view 2D dataset, kNNforGM.R then goes on to apply the function itself to wing morphology data from work on Drosophila melanogaster, adapted from Houle et al 2017.**
